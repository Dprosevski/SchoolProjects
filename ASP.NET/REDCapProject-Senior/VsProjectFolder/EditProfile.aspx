<%@ page language="C#" maintainscrollpositiononpostback="true" autoeventwireup="true" codebehind="EditProfile.aspx.cs" inherits="Capstone2nd.EditProfile" %>
...
<body id="page-top">
    ...
    <form id="form1" runat="server">
        ...
        <!--First Name-->
        <asp:Label ID="FirstName" runat="server" Text="Fisrt Name" ForeColor="Black" Font-Size="12pt"></asp:Label><br />
        <asp:TextBox ID="First_Name" runat="server" BackColor="White"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ErrorMessage="First Name is Required" Display="Dynamic" ControlToValidate="First_Name">*Required</asp:RequiredFieldValidator>
        <br />

         <!--Middle Name-->
        <asp:Label ID="lblMiddle" runat="server" Text="Middle Name" ForeColor="Black" Font-Size="12pt"></asp:Label><br />
        <asp:TextBox ID="middleName" runat="server" BackColor="White"></asp:TextBox><br />
       

        <!--Last Name-->
        <asp:Label ID="LastName" runat="server" Text="Last Name" ForeColor="Black" Font-Size="12pt"></asp:Label><br />
        <asp:TextBox ID="Last_Name" runat="server" BackColor="White"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="Last Name Required" Display="Dynamic" ControlToValidate="Last_Name">*Required</asp:RequiredFieldValidator>
        <hr />
        ...
        <asp:TextBox ID="currPass" TextMode="Password" BackColor="White" runat="server"></asp:TextBox>
        ...
        <asp:TextBox ID="newPass" TextMode="Password" BackColor="White" runat="server"></asp:TextBox>
        ...
        <asp:CompareValidator ID="compPass" runat="server" ForeColor="Red" ErrorMessage="Passwords do not match!"
            ControlToValidate="confirmPassword" ControlToCompare="newPass"></asp:CompareValidator><br />
        <hr />


        <!--Text Box for Alt Email Address-->
        <asp:Label  ID="lblAltEmail" runat="server" Text="Alternative Email Address:" ForeColor="Black" Font-Size="10pt"></asp:Label><br />
        <asp:TextBox  ID="altEmail" runat="server" BackColor="White"></asp:TextBox><br />
        <asp:RegularExpressionValidator ID="regexAltEmail" ForeColor="Red" runat="server"
            ...
            ErrorMessage="Invalid Alternative Email Format"></asp:RegularExpressionValidator><br />


        <!--Text Box for Phone -->
        <asp:Label ID="Phone" runat="server" Text="PhoneNumber" ForeColor="Black" Font-Size="12pt"></asp:Label><br />
        <asp:TextBox ID="Phone_Number" runat="server" BackColor="White"></asp:TextBox><hr />
