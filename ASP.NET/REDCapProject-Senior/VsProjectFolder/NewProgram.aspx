...
<body id="page-top">
    ...
    <form id="form1" runat="server">
       ...
       <!--Text Box for Program Cost-->
        ...
        <asp:RadioButtonList ID="stipendlist" runat="server" Font-Size="10" Font-Strikeout="False" ForeColor="Black" TextAlign="Left" AutoPostBack="true" OnSelectedIndexChanged="list_SelectedIndexChanged">
        </asp:RadioButtonList>
       ...
       <!--Text Box for Duration-->
        ...
        <asp:Label runat="server" ID="unilabel" Text="Name of institution with which the program is affiliated <br />" Visible="true"></asp:Label>
        ...
        <asp:RadioButtonList ID="eligibility" runat="server" AutoPostBack="true" OnSelectedIndexChanged="list_SelectedIndexChanged">
            <asp:ListItem value="Yes"></asp:ListItem>
            <asp:ListItem value="No"></asp:ListItem>
        </asp:RadioButtonList>
        ...
        <asp:Label runat="server" ID="serviceareaotherlabel" Text="Describe service area or geographical limitations from where you want to draw candidates <br />" Visible="true"></asp:Label>
        ...
        <!--Text Box for Start Date-->
        <asp:Label ID="Label1" runat="server" Text="Today's Date" ForeColor="Black" Font-Size="12pt"></asp:Label><br />
        <asp:TextBox ID="TextBox1" runat="server" BackColor="White" onfocus="this.select()" TextMode="Date"></asp:TextBox>
        <asp:RequiredFieldValidator ID="dateValidator" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" 
        ControlToValidate="TextBox1">*Required</asp:RequiredFieldValidator>
        <br>
        <br>
