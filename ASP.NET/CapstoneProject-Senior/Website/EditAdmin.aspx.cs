...
namespace Capstone2nd
{
    public partial class EditAdmin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM cap.Person WHERE email = @adminToEdit;", con);
            cmd.Parameters.Add(new SqlParameter("@adminToEdit", Session["adminToEdit"]));
            ...
            if (!IsPostBack)
            {
                ...
                if (typeCurr == "user")
                {
                    Session["message"] = "The user is not an admin.";
                    Response.Redirect("AdminPage.aspx");
                }
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Session["adminToEditPass"] = password.Text;
            Session["adminToEditAltPass"] = altPass.Text;
        ...
        protected void Confirm_Click(object sender, EventArgs e)
        {
            ...
            string passwordForm = Session["adminToEditPass"].ToString();
            string altEmailForm = altEmail.Text;
            string altPassForm = Session["adminToEditAltPass"].ToString();
            ...
            try
            {
                ...
                sql = "UPDATE cap.Person SET prefix = @prefix, firstName = @firstName, middleName = @middleName, lastName = @lastName, " +
                    ...
                    "address = @address, gender = @gender, DOB = @dob, heightFt = @heightFt, heightIn = @heightIn, " +
            ...
            Response.Redirect("AdminPage.aspx?AdminEdited", true);
        }
    }
}