...
namespace Capstone2nd
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Session["parentPassRegForm"] = parentPass.Text;
            Session["phoneRegForm"] = phone.Text.Replace("+", "").Replace(" ", "").Replace("(", "").Replace(")", "").Replace("-", "");
            ...
            try
            {
                ...
                else if (terms.Checked == true) //if user doesnt exist already and terms are checked
                {
                    form1.Visible = false;
                    form2.Visible = true;
                }
        ...
        protected void Confirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //check if the email already exist, email must be unique as this is the username
                con.Open();
                sql = "INSERT INTO  cap.Person ([type], [email], [password], [prefix], [firstName], [middleName], [lastName], [sufix], [gender], [DOB], [parentPassword], " +
                    ...
                    "values('user', @email, @password, @prefix, @first, @middle, @last, @sufix, @gender, @dob, @parentPass, @altEmail, @altPassword," +
